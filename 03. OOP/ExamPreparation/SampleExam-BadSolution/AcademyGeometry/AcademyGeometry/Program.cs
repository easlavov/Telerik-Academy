...
namespace GeometryAPI
{
    ...
    public class Circle : Figure, IFlat, IAreaMeasurable
    {
        ...
        public Circle(Vector3D a, double radius)
            : base(a)
        {
            this.Radius = radius;
        }
    ...
    public class Cylinder : Figure, IAreaMeasurable, IVolumeMeasurable
    {
        ...
        {
            double height = (this.TopCircle - this.BottomCircle).Magnitude;
            return height;
        }

        //public double GetArea()
        //{
        //    double area = 2 * Math.PI * this.Radius * this.Radius + 2 * Math.PI * this.Radius * this.GetHeight();
        //    return area;
        //}
        ...
        public double GetArea()
        {
            ...
            double sideArea = basePerimeter * (this.TopCircle - this.BottomCircle).Magnitude;
        ...
        {
            double volume = Math.PI * this.Radius * this.Radius * this.GetHeight();
            return volume;
        }
